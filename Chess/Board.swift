...
class Board {
    ...
    fileprivate var data = Array<Piece>(repeating: .empty, count: 64)
    
    func clearBoard() {
        data = Array<Piece>(repeating: .empty, count: 64)
    }
    
    func setUp() {
        setPiece(space: .a1, piece: .whiteRook)
        setPiece(space: .b1, piece: .whiteKnight)
        setPiece(space: .c1, piece: .whiteBishop)
        setPiece(space: .d1, piece: .whiteQueen)
        setPiece(space: .e1, piece: .whiteKing)
        setPiece(space: .f1, piece: .whiteBishop)
        setPiece(space: .g1, piece: .whiteKnight)
        setPiece(space: .h1, piece: .whiteRook)
        setPiece(space: .a2, piece: .whitePawn)
        setPiece(space: .b2, piece: .whitePawn)
        setPiece(space: .c2, piece: .whitePawn)
        setPiece(space: .d2, piece: .whitePawn)
        setPiece(space: .e2, piece: .whitePawn)
        setPiece(space: .f2, piece: .whitePawn)
        setPiece(space: .g2, piece: .whitePawn)
        setPiece(space: .h2, piece: .whitePawn)
        
        setPiece(space: .a8, piece: .blackRook)
        setPiece(space: .b8, piece: .blackKnight)
        setPiece(space: .c8, piece: .blackBishop)
        setPiece(space: .d8, piece: .blackQueen)
        setPiece(space: .e8, piece: .blackKing)
        setPiece(space: .f8, piece: .blackBishop)
        setPiece(space: .g8, piece: .blackKnight)
        setPiece(space: .h8, piece: .blackRook)
        setPiece(space: .a7, piece: .blackPawn)
        setPiece(space: .b7, piece: .blackPawn)
        setPiece(space: .c7, piece: .blackPawn)
        setPiece(space: .d7, piece: .blackPawn)
        setPiece(space: .e7, piece: .blackPawn)
        setPiece(space: .f7, piece: .blackPawn)
        setPiece(space: .g7, piece: .blackPawn)
        setPiece(space: .h7, piece: .blackPawn)
    }
    
    func setPiece(space: Space, piece: Piece) {
    ...
    func printRank(rank: Rank) {
        print(rank.spaces.map{data[$0.rawValue].description})
    }
    ...
    func testMoves(space: Space, piece: Piece) {
        ...
        switch piece {
        case .whiteKnight, .blackKnight: spaces = space.knightMoves
        case .whiteRook, .blackRook: spaces = space.rank.spaces + space.file.spaces
        case .whiteBishop, .blackBishop: spaces = space.diagonals.flatMap { $0.spaces }
        case .whiteQueen, .blackQueen: spaces = space.diagonals.flatMap { $0.spaces } + space.rank.spaces + space.file.spaces
        default: break
        }
        
        clearBoard()
        setPiece(space: space, piece: piece)
        for space in spaces {
            setPiece(space: space, piece: piece)
        }
